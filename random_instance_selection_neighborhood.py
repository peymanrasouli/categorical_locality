...
class RandomInstanceSelectionNeighborhood():
    def __init__(self,
                 X,
                 y,
                 model,
    ...
    def neighborhoodSampling(self, x, N_samples):
        ...
        # generating random instance selection neighborhood data
        Z_df, Z = random_instance_selection(self.dfZ, x, self.model, self.dataset, N_samples)
